...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/第3阶段：Java高级应用-第10章.png" alt="第3阶段：Java高级应用-第10章" style="zoom: 50%;" />

***

我们之前学习的程序在没有跳转语句的情况下，都是由上至下沿着一条路径依次执行。现在想要设计一个程序，可以同时有多条执行路径同时执行。比如，`一边游戏，一边qq聊天，一边听歌`，怎么设计？

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/c3dcb61e3b.png" alt="c3dcb61e3b" style="zoom:50%;" />
...
* **线程（thread）**：进程可进一步细化为线程，是程序内部的`一条执行路径`。一个进程中至少有一个线程。
  ...
  - 一个进程同一时间若`并行`执行多个线程，就是支持多线程的。
    ...
    <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220331233204504.png" alt="image-20220331233204504" style="zoom:67%;" />
  ...
  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514175737426.png" alt="image-20220514175737426" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/进程概念.png" style="zoom:80%;" />

2、一个应用程序的多次运行，就是多个进程

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/1563267431480.png" alt="1563267431480" style="zoom:80%;" />

3、一个进程中包含多个线程

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/1563270525077.png" alt="1563270525077" style="zoom:80%;" />
...
- **抢占式调度**
  ...
  ![抢占式调度](https://images73.oss-cn-beijing.aliyuncs.com/img/抢占式调度.bmp)
...
* **并行（parallel）**：指两个或多个事件在`同一时刻`发生（同时发生）。指在同一时刻，有`多条指令`在`多个CPU`上`同时`执行。比如：多个人同时做不同的事。
  ...
  ![image-20220401000804242](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401000804242.png)

  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220513181758585.png" alt="image-20220513181758585" style="zoom: 50%;" />

* **并发（concurrency）**：指两个或多个事件在`同一个时间段内`发生。即在一段时间内，有`多条指令`在`单个CPU`上`快速轮换、交替`执行，使得在宏观上具有多个进程同时执行的效果。

  ![image-20220401000515678](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401000515678.png)
  
  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220513181815978.png" alt="image-20220513181815978" style="zoom:50%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401221215860.png" alt="image-20220401221215860" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401222212377.png" alt="image-20220401222212377"  />
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/这是要闹哪样.jpg)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401002307038.png" alt="image-20220401002307038" style="zoom: 67%;" />
...
![image-20220524203355448](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220524203355448.png)

或

![线程的生命周期Thread.State](https://images73.oss-cn-beijing.aliyuncs.com/img/线程的生命周期Thread.State.jpg)
...
![image-20220524195035355](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220524195035355.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220401233218326.png" alt="image-20220401233218326" style="zoom:67%;" />



类比：

![](https://images73.oss-cn-beijing.aliyuncs.com/img/当我以为我的代码很安全时，等等.gif)
...
![1563372934332](https://images73.oss-cn-beijing.aliyuncs.com/img/1563372934332.png)
...
![thread-lock](https://images73.oss-cn-beijing.aliyuncs.com/img/thread-lock.png)
...
![线程池的理解](https://images73.oss-cn-beijing.aliyuncs.com/img/线程池的理解.jpg)
