...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/第3阶段：Java高级应用-第12章.png" alt="第3阶段：Java高级应用-第12章" style="zoom:50%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220523190743146.png" alt="image-20220523190743146" style="zoom: 67%;" />
...
![集合框架全图.png](https://images73.oss-cn-beijing.aliyuncs.com/img/集合框架全图.png)

- 简图1：**Collection接口继承树**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220407203244029.png" alt="image-20220407203244029" style="zoom: 67%;" />

- 简图2：**Map接口继承树**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220407203412665.png" alt="image-20220407203412665" style="zoom: 67%;" />

### 1.4 集合的使用场景

![image-20220407202630027](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220407202630027.png)

![第12章_集合的使用场景](https://images73.oss-cn-beijing.aliyuncs.com/img/第12章_集合的使用场景.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/1563548078274.png)
...
![image-20220407235130988](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220407235130988.png)
...
![image-20220128010114124](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220128010114124.png)
...
![1563549818689](https://images73.oss-cn-beijing.aliyuncs.com/img/1563549818689.png)
...
- Arrays.asList(…) 方法返回的 List 集合，既不是 ArrayList 实例，也不是 Vector 实例。 Arrays.asList(…) 返回值是一个固定长度的 List 集合
  ...
  ![image-20220408210743342](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220408210743342.png)

### 4.4 List的实现类之二：LinkedList

- 对于频繁的插入或删除元素的操作，建议使用LinkedList类，效率较高。这是由底层采用链表（双向链表）结构存储数据决定的。

![image-20220408225615829](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220408225615829.png)
...
* 代码实现，效果如图所示：
  ...
  ![1559890098509](https://images73.oss-cn-beijing.aliyuncs.com/img/1559890098509.png)
...
![1559896150606](https://images73.oss-cn-beijing.aliyuncs.com/img/1559896150606.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220408235936404.png" alt="image-20220408235936404" style="zoom:67%;" />
...
- Map接口的常用实现类：`HashMap`、`LinkedHashMap`、`TreeMap`和``Properties`。其中，HashMap是 Map 接口使用`频率最高`的实现类。
  ...
  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220409001015034.png" alt="image-20220409001015034" style="zoom:67%;" />

### 6.2 Map中key-value特点

这里主要以HashMap为例说明。HashMap中存储的key、value的特点如下：

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220409001213720.png" alt="image-20220409001213720" style="zoom:67%;" />

- Map 中的 `key用Set来存放`，`不允许重复`，即同一个 Map 对象所对应的类，须重写hashCode()和equals()方法

  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514190412763.png" alt="image-20220514190412763" style="zoom:67%;" />
...
![image-20220914190805362](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220914190805362.png)
...
![img](https://images73.oss-cn-beijing.aliyuncs.com/img/clip_image001.png)
...
![image-20220409003002526](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220409003002526.png)
...
![image-20220409011625061](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220409011625061.png)
...
![image-20220915002714578](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220915002714578.png)
