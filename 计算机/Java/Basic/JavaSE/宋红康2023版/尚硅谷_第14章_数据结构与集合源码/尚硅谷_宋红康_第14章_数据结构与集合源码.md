...
![第3阶段：Java高级应用-第14章](https://images73.oss-cn-beijing.aliyuncs.com/img/第3阶段：Java高级应用-第14章.png)

## 1. 数据结构剖析

我们举一个形象的例子来理解数据结构的作用：

![image-20220412011531879](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220412011531879.png)
...
> **战术和策略：**数据结构
 ...
 ![image-20220412011555025](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220412011555025.png)

上图：没有战术，打仗事倍功半

 ![image-20220412011600845](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220412011600845.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220824011022664.png" alt="image-20220824011022664" style="zoom:67%;" />
...
![image-20220521100746910](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521100746910.png)
...
![image-20220521103734742](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521103734742.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521115200921.png" alt="image-20220521115200921" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521115734571.png" alt="image-20220521115734571" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/数据结构.png" alt="数据结构" style="zoom: 40%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/1563432676234.png" alt="1563432676234" style="zoom: 80%;" />

例如：对象数组

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/1563432696340.png" alt="1563432696340" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/数据结构-一维数组.png" alt="数据结构-一维数组" style="zoom: 50%;" />
...
![image-20220511113744772](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220511113744772-1661445988505.png)

- 常见的链表结构有如下的形式：


![1563448858180](https://images73.oss-cn-beijing.aliyuncs.com/img/1563448858180-1661445988506.png)

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/数据结构-链表.png" alt="数据结构-链表" style="zoom:50%;" />

### 3.2 自定义链表

#### 3.2.1 自定义单向链表

![image-20221028195106363](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221028195106363.png)
...
![image-20220514165707977](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514165707977-1661448081075.png)
...
- 栈按照`先进后出(FILO,first in last out)`的原则存储数据，先进入的数据被压入栈底，最后的数据在栈顶。每次删除（退栈）的总是删除当前栈中最后插入（进栈）的元素，而最先插入的是被放在栈的底部，要到最后才能删除。
   ...
   ![image-20221028192349993](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221028192349993.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220826010258638.png" alt="image-20220826010258638" style="zoom:80%;" />

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/数据结构-栈.png" alt="数据结构-栈" style="zoom:50%;" />
...
![image-20220826010241172](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220826010241172.png)

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/数据结构-队列.png" alt="数据结构-队列" style="zoom:50%;" />

## 6. 树与二叉树

### 6.1 树的理解

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521111904272.png" alt="image-20220521111904272" style="zoom:67%;" />
...
![1563449427345](https://images73.oss-cn-beijing.aliyuncs.com/img/1563449427345-1661447692846.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/1574575739236-1661447692846.png" alt="1574575739236" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521153016348.png" alt="image-20220521153016348" style="zoom: 67%;" />

1、`满二叉树`： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第n层的结点数是2的n-1次方，总的结点个数是2的n次方-1

![1574575163883](https://images73.oss-cn-beijing.aliyuncs.com/img/1574575163883-1661447692846.png)

2、`完全二叉树`： 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![1574575180247](https://images73.oss-cn-beijing.aliyuncs.com/img/1574575180247-1661447692846.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521145208018.png" alt="image-20220521145208018" style="zoom: 67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220521150151219.png" alt="image-20220521150151219" style="zoom: 50%;" />
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/红黑树-1661447692846.jpeg)
...
2、`rotation` ：将红黑树某些结点分支进行旋转（左旋或右旋）
 ...
 ![image-20221208212053079](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221208212053079.png)
...
![1563549818689](https://images73.oss-cn-beijing.aliyuncs.com/img/1563549818689-1661447917313.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029112037297.png" alt="image-20221029112037297" style="zoom:80%;" />

- **ArrayList自动扩容过程**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029112107691.png" alt="image-20221029112107691" style="zoom:80%;" />

- **ArrayList的add(E e)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029112129161.png" alt="image-20221029112129161" style="zoom:80%;" />

- **ArrayList的add(int index,E e)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029112157007.png" alt="image-20221029112157007" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029134437888.png" alt="image-20221029134437888" style="zoom:80%;" />

- **包含4个元素的LinkedList**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029134534198.png" alt="image-20221029134534198" style="zoom:80%;" />

- **add(E e)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029135013377.png" alt="image-20221029135013377" style="zoom:80%;" />

- **add(int index,E e)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029135045120.png" alt="image-20221029135045120" style="zoom:80%;" />

- **remove(Object obj)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029134721089.png" alt="image-20221029134721089" style="zoom:80%;" />

- **remove(int index)方法**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029134807613.png" alt="image-20221029134807613" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029144811305.png" alt="image-20221029144811305" style="zoom:80%;" />
...
![image-20220514190849626](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514190849626-1661448231966.png)
...
![image-20220514190904009](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514190904009-1661448231966.png)
...
![image-20220524142524796](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220524142524796-1661448231966.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221029145708224.png" alt="image-20221029145708224" style="zoom:80%;" />
...
![1563797150134](https://images73.oss-cn-beijing.aliyuncs.com/img/1563797150134-1661448231965.png)
...
![image-20220514190454633](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514190454633-1661448231965.png)
...
![1563800372286](https://images73.oss-cn-beijing.aliyuncs.com/img/1563800372286-1661448231966.png)
...
![1563802656661](https://images73.oss-cn-beijing.aliyuncs.com/img/1563802656661-1661448231966.png)

JDK1.8之后使用：数组+链表/红黑树的结构。

![1563802665708](https://images73.oss-cn-beijing.aliyuncs.com/img/1563802665708-1661448231966.png)
...
![HashMap的循环引用问题](https://images73.oss-cn-beijing.aliyuncs.com/img/HashMap的循环引用问题.jpg)
