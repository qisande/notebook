...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_beA-9rcg2C.png)
...
2.  项目搭建和准备
    1.  项目搭建
        ...
        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_ABKtnvaSLe.png)
    2.  依赖导入
...
3.  准备Mapper接口和MapperXML文件
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_pikdpXSaNV.png)
    1.  定义mapper接口
...
6.  SqlSession和HttpSession区别
    ...
    -   SqlSession：不依赖Web服务器，属于持久化层。
        -   代表Java程序和数据库之间的会话。
            ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_nCsKIKFBM7.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_Sd6pCEE6Oi.png)

#### 2.1.3 **\${}形式**

\${}形式传参，底层Mybatis做的是字符串拼接操作。

![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_KYrG3XT73t.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_UeTV_XwcBt.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_UTL-tjGuzm.png)
...
-   Mapper 配置文件放在 Mapper 接口所在的包内
    ...
    -   可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件
        ...
        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_ehqr6FrNXV.png)

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_PhqgFRgNDi.png)
...
2.  使用 IntelliJ IDEA连接数据库
    -   连接数据库
        ...
        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_yKs2Z2_8sQ.png)
    -   填写信息

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_bDboqlZFKD.png)
    -   展示库表

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_mCMuBhwZl2.png)
    -   逆向工程使用

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_DkwlIx_BM9.png)

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_dJvZP76xYm.png)

        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_KXYfK5CQd-.png)
3.  查看生成结果

    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_IIK2v1Lk64.png)
4.  逆向工程案例使用
