...
-   分布式架构
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_rR3xK4zw_I.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_bBuJMTIkuZ.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_gKSoeADbKW.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_iZefjOGOWr.png)
...
-   **3.1.1 什么是组件?**
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_Gusp1HuW3X.png)

    整个项目就是由各种组件搭建而成的：

    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_evy1Qf9TmX.png)
-   **3.1.2 我们的期待**
    -   有人替我们创建组件的对象
    -   有人帮我们保存组件的对象
    -   有人帮助我们自动组装
...
-   **3.2.2 SpringIoC容器介绍**
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_xogFLaPVQN.png)
...
4.  基于无参数构造函数
    ...
    2.  xml配置文件编写
        ...
        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_VcUvHx6Air.png)
...
7.  图解IoC配置流程
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_1TRaZzVWj_.png)
...
2.  思路
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_Av7Jxm_Dok.png)
...
1.  介绍
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_rdPHb-P61b.png)
...
1.  FactoryBean简介
    ...
    -   `Class<?> getObjectType()`: 返回 `getObject()` 方法返回的对象类型，如果事先不知道类型，则返回 `null` 。
        ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_lCmgMdmbvi.png)
2.  FactoryBean使用场景
    1.  代理类的创建
    2.  第三方框架整合
    3.  复杂对象实例化等
...
1.  需求分析
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_oAOD-VE7wl.png)
2.  数据库准备
    ```java
...
1.  需求分析
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_lKlXB-ggSc.png)
2.  数据库准备
    ```java
    create database studb;
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_XWhvLQBC2h.png)
...
1.  需求分析
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_mQnh0_wyzf.png)
2.  数据库准备
    ```java
    create database studb;
...
1.  **面向切面编程思想AOP**
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_xQXRF5ErbI.png)

    AOP技术恰恰相反，它利用一种称为"横切"的技术，剖解开封装的对象内部，并将那些影响了多个类的公共行为封装到一个可重用模块，并将其命名为"Aspect"，即切面。所谓"切面"，简单说就是那些与业务无关，却为业务模块所共同调用的逻辑或责任封装起来，便于减少系统的重复代码，降低模块之间的耦合度，并有利于未来的可操作性和可维护性。

    使用AOP，可以在不修改原来代码的基础上添加新功能。

    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_sE31XbRchi.png)
2.  **AOP思想主要的应用场景**
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_EbfR90kP01.png)

对没实现接口的类应用切面new

![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_wUfCJhIWI3.png)
...
2.  Spring声明式事务对应事务管理器接口
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/image_s2BCX_Qltm.png)
...
1.  事务传播行为要研究的问题
    ...
    ![](https://images73.oss-cn-beijing.aliyuncs.com/img/img012.faac2cb7.png)
