...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/第2阶段：Java面向对象编程-第08章.png" alt="第2阶段：Java面向对象编程-第08章" style="zoom: 200%;" />
...
![image-20220325213629311](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325213629311.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514183814514.png" alt="image-20220514183814514" style="zoom:67%;" />
...
![image-20220104100145059](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220104100145059.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220520174508815.png" alt="image-20220520174508815" style="zoom: 80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325222541203.png" alt="image-20220325222541203" style="zoom:67%;" />
...
![image-20220325223215924](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325223215924.png)

IDEA工具：

（1）配置运行参数

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20211228101828718.png" alt="image-20211228101828718" style="zoom: 80%;" />

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20211228102022216.png" alt="image-20211228102022216" style="zoom:67%;" />

（2）运行程序

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20211228102059327.png" alt="image-20211228102059327" style="zoom: 80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325230208941.png" alt="image-20220325230208941" style="zoom:67%;" />
...
![image-20220325231608838](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325231608838.png)
...
![image-20220517204707255](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220517204707255.png)
...
![image-20220325232847872](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325232847872.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220503145003315.png" alt="image-20220503145003315" style="zoom: 80%;" />

制作月饼的模板：

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220517205013997.png" alt="image-20220517205013997" style="zoom: 50%;" />
...
![image-20220504164925878](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220504164925878.png)
...
![bbcc80f541000c71b81650cfaa770c86](https://images73.oss-cn-beijing.aliyuncs.com/img/bbcc80f541000c71b81650cfaa770c86.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220517211517846.png" alt="image-20220517211517846" style="zoom:67%;" />

- 例如：Java程序是否能够连接使用某种数据库产品，那么要看该数据库产品能否实现Java设计的JDBC规范

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325235434103.png" alt="image-20220325235434103" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514163212312.png" alt="image-20220514163212312" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514163311418.png" alt="image-20220514163311418" style="zoom:80%;" />

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220325235321778.png" alt="image-20220325235321778" style="zoom:67%;" />

![1562216188519](https://images73.oss-cn-beijing.aliyuncs.com/img/1562216188519.png)
...
![](https://images73.oss-cn-beijing.aliyuncs.com/img/选择困难.jpg)
...
![image-20220328002053452](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220328002053452.png)
...
![image-20220504172547709](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220504172547709.png)

其中，有一个乘坐交通工具的方法takingVehicle()，在此方法中调用交通工具的run()。为了出行方便，他买了一辆捷安特自行车、一辆雅迪电动车和一辆奔驰轿车。这里涉及到的相关类及接口关系如下：

![image-20220504172918861](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220504172918861.png)
...
![image-20221124223912529](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221124223912529.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220511181800694.png" alt="image-20220511181800694" style="zoom: 50%;" />

![image-20220524102038600](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220524102038600.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20211228180938922.png" alt="image-20211228180938922" style="zoom:80%;" />

![image-20221002195547325](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20221002195547325.png)

其中，junit-libs包内容如下：

![image-20220813005206452](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813005206452.png)

第2步：选择要在哪些module中应用JUnit库

![image-20220813005511062](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813005511062.png)

第3步：检查是否应用成功

![image-20220813005729233](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813005729233.png)

**注意Scope：选择Compile，否则编译时，无法使用JUnit。**

第4步：下次如果有新的模块要使用该libs库，这样操作即可

![image-20220813005944022](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813005944022.png)

![image-20220813010018152](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813010018152.png)

![image-20220813010055217](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813010055217.png)

![image-20220813010124381](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813010124381.png)
...
![image-20220106152412245](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220106152412245.png)
...
![image-20220813011625546](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813011625546.png)

![image-20220813011642180](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813011642180.png)
...
![image-20211229100040505](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20211229100040505.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220329001912486.png" alt="image-20220329001912486" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514163725830.png" alt="image-20220514163725830" style="zoom:80%;" />
...
![image-20220813012801907](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220813012801907.png)
