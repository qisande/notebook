...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/第1阶段：Java基本语法-第02章.png" alt="第1阶段：Java基本语法-第02章" style="zoom:40%;" />
...
![image-20220310234414849](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220310234414849.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220310234557454.png" alt="image-20220310234557454" style="zoom: 67%;" />

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220801143635356.png" alt="image-20220801143635356" style="zoom:66%;" />
...
![image-20220513235020527](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220513235020527.png)

一花一世界，如果把一个程序看做一个世界或一个社会的话，那么变量就是程序世界的花花草草、万事万物。即，**变量是程序中不可或缺的组成单位，最基本的存储单元**。

![image-20220513235828042](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220513235828042.png)
...
- 变量的概念：
  ...
  - Java中变量声明的格式：`数据类型 变量名 = 变量值`
    ...
    <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220311000744867.png" alt="image-20220311000744867" style="zoom:67%;" />
...
- **引用数据类型**：包括`数组`、 `类`、`接口`、`枚举`、`注解`、`记录`。 
  ...
  ![Java的数据类型](https://images73.oss-cn-beijing.aliyuncs.com/img/Java的数据类型.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514152216148.png" alt="image-20220514152216148" style="zoom: 80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220520111756274.png" alt="image-20220520111756274" style="zoom: 50%;" />

- Java各整数类型有固定的表数范围和字段长度，不受具体操作系统的影响，以保证Java程序的可移植性。

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220311001553945.png" alt="image-20220311001553945" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220311001749699.png" alt="image-20220311001749699" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220523162200891.png" alt="image-20220523162200891" style="zoom:67%;" />

基本数据类型的转换规则如图所示：

![image-20220311002543688](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220311002543688.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220523162407722.png" alt="image-20220523162407722" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/010101.jpg" alt="010101" style="zoom: 33%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220520105721126.png" alt="image-20220520105721126" style="zoom:67%;" />

记忆技巧：

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/morsecode.jpg" alt="morsecode" style="zoom:50%;" />

我们偶尔会看到的：SOS，即为：

![image-20220520110206899](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220520110206899.png)
...
![image-20220523114701881](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220523114701881.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000042595.png" alt="image-20220312000042595" style="zoom:67%;" />

### 6.6 二进制与八进制、十六进制间的转换

**二进制转八进制**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000233863.png" alt="image-20220312000233863" style="zoom:80%;" />

**二进制转十六进制**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000251113.png" alt="image-20220312000251113" style="zoom:80%;" />

**八进制、十六进制转二进制**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000341297.png" alt="image-20220312000341297" style="zoom: 67%;" />

### 6.7 各进制间的转换

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000143438.png" alt="image-20220312000143438" style="zoom:80%;" />
...
![image-20220312000848332](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312000848332.png)
...
![image-20220312001742263](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312001742263.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312001943403.png" alt="image-20220312001943403" style="zoom: 67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220313174721111.png" alt="image-20220313174721111" style="zoom:75%;" />

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312002506339.png" alt="image-20220312002506339" style="zoom:67%;" />
...
![image-20200225113651675](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225113651675.png)

```java
-3<<4  类似于  -3*2的4次幂 => -3*16 => -48
```

![image-20200225114707524](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225114707524.png)
...
![image-20200225115636844](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225115636844.png)

```
-69>>4  类似于  -69/2的4次 = -69/16 = -5
```

![image-20200225120112188](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225120112188.png)
...
![image-20200225121104734](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225121104734.png)

```
-69>>>4   结果：268435451
```

![image-20200225121244290](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225121244290.png)
...
![image-20200225122440953](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225122440953.png)

```java
-9 & 7 = 7
```

![image-20200225122221616](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225122221616.png)
...
![image-20200225122758851](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225122758851.png)

```java
-9 | 7 //结果： -9
```

![image-20200225123409130](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225123409130.png)
...
![image-20200225123445305](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225123445305.png)

```java
-9 ^ 7 //结果为-16
```

![image-20200225133145727](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225133145727.png)
...
![image-20200225124112662](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225124112662.png)

```java
~-9  //结果：8
```

![image-20200225124156862](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20200225124156862.png)

#### 7.5.2 举例

**举例1：**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/snipaste_20220312_002549.jpg" alt="snipaste_20220312_002549" style="zoom: 67%;" />

**举例2：体会 m = k ^ n = (m ^ n) ^ n**

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312002736157.png" alt="image-20220312002736157" style="zoom:67%;" />
...
- 说明：条件表达式是boolean类型的结果，根据boolean的值选择表达式1或表达式2
  ...
  <img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220312002841945.png" alt="image-20220312002841945" style="zoom:67%;" />
...
![image-20220513095907601](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220513095907601.png)
