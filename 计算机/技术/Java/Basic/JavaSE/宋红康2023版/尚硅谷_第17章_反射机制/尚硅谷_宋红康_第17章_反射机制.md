...
![image-20231016190557447](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20231016190557447.png)
...
![image-20231016190625012](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20231016190625012.png)

**从内存加载上看反射：**

![image-20220524101448625](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220524101448625.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417162559217.png" alt="image-20220417162559217" style="zoom:80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220514180100176.png" alt="image-20220514180100176" style="zoom:80%;" />
...
![image-20220417173459849](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417173459849.png)

### 3.2 类的加载过程

当程序主动使用某个类时，如果该类还未被加载到内存中，系统会通过加载、链接、初始化三个步骤来对该类进行初始化。如果没有意外，JVM将会连续完成这三个步骤，所以有时也把这三个步骤统称为类加载。

<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417171411631.png" alt="image-20220417171411631" style="zoom: 50%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417173647473.png" alt="image-20220417173647473" style="zoom:67%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417173616344.png" alt="image-20220417173616344" style="zoom: 80%;" />
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417173819953.png" alt="image-20220417173819953" style="zoom:80%;" />
...
![image-20220417174032702](https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417174032702.png)
...
<img src="https://images73.oss-cn-beijing.aliyuncs.com/img/image-20220417181700813.png" alt="image-20220417181700813" style="zoom:80%;" />
